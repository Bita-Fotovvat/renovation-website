    ...
    return(
        <main className="aboutus__main">
            ...
            <article className="aboutus__wrapper">
                ...
                <p className="aboutus__subcontent1">Xeus Home is a leading home remodeling and renovation company serving clients all over Ontario.</p>
